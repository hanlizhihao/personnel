...
(function (t, i, e, s) {
    ...
    var o = t(i), a = "waterfall", r = {
        ...
        state: {isDuringAjax: !1, isProcessingData: !1, isResizing: !1, isPause: !1, curPage: 1},
        callbacks: {
    ...
    n.prototype = {
        constructor: n, _debug: function () {
            ...
            var i = this.options, e = i.prefix;
            t("body").css({}), this.$element.css(this.options.containerStyle).addClass(e + "-container"), this.$element.after('<div id="' + e + '-loading">' + i.loadingMsg + '</div><div id="' + e + '-message" style="text-align:center;color:#999;"></div>'), this.$loading = t("#" + e + "-loading"), this.$message = t("#" + e + "-message")
        }, _getColumns: function () {
            var t = this.options, i = t.fitWidth ? this.$element.parent() : this.$element, e = "BODY" === i[0].tagName ? i.width() - 20 : i.width(), s = t.colWidth, n = t.gutterWidth, o = t.minCol, a = t.maxCol, r = Math.floor(e / (s + n)), l = Math.max(r, o);
            return a ? l > a ? a : l : l
        }, _setColumns: function () {
            this.cols = this._getColumns()
        }, _getItems: function (t) {
            var i = t.filter("." + this.options.itemCls).css({position: "absolute"});
            return i
        }, _resetColumnsHeightArray: function () {
            var t, i = this.cols;
            for (this.colHeightArray.length = i, t = 0; i > t; t++)this.colHeightArray[t] = 0
        }, layout: function (t, i) {
            var e, s, n, o, a, r, l = this.options, h = this.options.isFadeIn ? this._getItems(t).css({opacity: 0}).animate({opacity: 1}) : this._getItems(t), A = this.options.isAnimated && this.options.state.isResizing ? "animate" : "css", c = l.animationOptions, u = l.colWidth, g = l.gutterWidth, d = this.colHeightArray.length, p = l.align;
            ...
            var s, n, o = t(i), a = this.options, r = a.colWidth, l = a.gutterWidth, h = a.gutterHeight, A = this.colHeightArray, c = A.length, u = Math.min.apply({}, A), g = t.inArray(u, A);
            s = o.hasClass(a.prefix + "-item-fixed-left") ? 0 : o.hasClass(a.prefix + "-item-fixed-right") ? c > 1 ? c - 1 : 0 : g, n = {
                left: (r + l) * s + e,
                top: A[s]
            }, this.styleQueue.push({$el: o, style: n}), A[s] += o.outerHeight() + h
            ...
            var e, n = this, o = this.options, a = o.maxPage, r = o.state.curPage++, l = o.path, h = o.dataType, A = o.params;
            ...
            var s = this, n = this.options, o = t.trim(n.callbacks.renderData(i, n.dataType)), a = t(o), r = n.checkImagesLoaded;
            ...
            var t = this.options, i = Math.min.apply({}, this.colHeightArray), e = o.scrollTop() + o.height() - this.$element.offset().top - i;
            return this._debug("math:", e), e > t.bufferPixel
        }, _prefill: function () {
            this.$element.height() <= o.height() && this._scroll()
        }, _scroll: function () {
            var t = this.options, i = t.state, e = this;
            ...
            var t = this.cols, i = this._getColumns();
...
})(jQuery, window, document), function (t, i) {
    "use strict";
    ...
    t.fn.imagesLoaded = function (s) {
        ...
        var r = this, l = t.isFunction(t.Deferred) ? t.Deferred() : 0, h = t.isFunction(l.notify), A = r.find("img").add(r.filter("img")), c = [], u = [], g = [];
        return t.isPlainObject(s) && t.each(s, function (t, i) {
            ...
            var o = n.src, r = t.data(n, "imagesLoaded");
