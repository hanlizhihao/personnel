            ...
            destroy: function () {
                ...
                if (!opts.customToggle) {
                    ...
                    if (document.getElementById(toggleEl)) {
                        ...
                        if (document.querySelector(toggleEl)) {
...
!function ($) {
    var plugin = "emailsuggest", defaults = {
        sugClass: "emailSug",
    ...
    EmailSug.prototype = {
        init: function () {
            ...
            var that = this, arr, len, fragment, ul = [], offset, left, top, width, height, style, borderWidth = 2;
            elem = $(elem);
            offset = elem.offset();
            ...
            var elems = $("." + this.options.sugClass + "-item", this.$suggest), min = 0, max = elems.length - 1;
            switch (keyCode) {
                case 13:
...
!(function ($) {
                    ...
                    self.on(_click + ".i focus.i blur.i keyup.i keydown.i keypress.i", function (event) {
                        ...
                        if (type == _click) {
                            ...
                            if (type == "keydown" && key == 32) {
                                ...
                                if (type == "keyup" && node[_type] == _radio) {
    ...
    function operate(input, direct, method) {
        ...
        if (/^(ch|di|in)/.test(method) && !active) {
            ...
            if (/^(un|en|de)/.test(method) && active) {
                off(input, state)
            } else {
                if (method == _update) {
    ...
    var methods = {
        init: function (settings) {
            ...
            self.stars.bind(action, function (evt) {
                ...
                if (self.opt.half) {
                    var position = parseFloat((evt.pageX - $(this).offset().left) / self.opt.size), diff = (position > 0.5) ? 1 : 0.5;
...
!(function ($) {
    $.fn.onePageNav = function (options) {
        var opts = $.extend({}, $.fn.onePageNav.defaults, options), onePageNav = {};
        onePageNav.sections = {};
        onePageNav.bindNav = function ($el, $this, o) {
            var $par = $el.parent(), newLoc = $el.attr("href"), $win = $(window);
        ...
        onePageNav.getPositions = function ($this, o) {
            ...
            $nav.each(function () {
                var linkHref = $(this).attr("href"), divPos = $(linkHref).offset(), topPos = divPos.top;
                onePageNav.sections[linkHref.substr(1)] = Math.round(topPos) - o.scrollOffset
            })
        };
        onePageNav.getSection = function (windowPos, o) {
            var returnValue = "", windowHeight = Math.round($(window).height() * o.scrollThreshold);
        ...
        onePageNav.scrollChange = function ($this, o) {
            ...
            var windowTop = $(window).scrollTop(), position = onePageNav.getSection(windowTop, o);
            if (position !== "") {
                onePageNav.adjustNav($this, $this.find("a[href=#" + position + "]").parent(), o.currentClass)
            }
        };
        onePageNav.init = function ($this, o) {
            var didScroll = false, $nav = $this.find("a");
            if (o.filter !== "") {
                $nav = $nav.filter(o.filter)
            }
...
!function ($) {
    $.Huimarquee = function (height, speed, delay) {
        ...
        if (document.getElementById("holder").offsetHeight <= height) {
            return
        }
...
!function ($) {
    ...
    Dropdown.prototype.toggle = function (e) {
        ...
        if (!isActive) {
            ...
            if (e.isDefaultPrevented()) {
                return $this.trigger("focus").attr("aria-expanded", "true")
            }
        ...
        var methods = {
            init: function () {
                return this.each(function () {
                    ...
                    $.each(["size-MINI", "size-S", "size-L"], function (i, el) {
